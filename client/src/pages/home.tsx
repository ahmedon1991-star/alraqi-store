              ...
              return (
                <div key={cat.id} className="animate-fade-up">
                  ...
                  <div className="grid grid-cols-3 lg:grid-cols-4 gap-2 md:gap-12">
                    ...
                    <Link href={`/shop?category=${cat.id}`} className="col-span-1 md:col-span-1 flex flex-col items-center justify-center gap-2 md:gap-6 rounded-[1rem] md:rounded-[4rem] border-2 border-dashed border-primary/20 bg-primary/5 hover:bg-primary/10 transition-all cursor-pointer min-h-[100px] md:min-h-[400px]">
                      ...
                      <span className="font-heading font-black text-[9px] md:text-3xl text-primary text-center">عرض الكل</span>
                    </Link>
                  </div>
                </div>
              );
